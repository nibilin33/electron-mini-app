...
<template>
  ...
  <template v-else>
    <div class="header">
      <div class="banner">
        <div class="banner__title">Lique</div>
    ...
    <div class="body">
      <div
        class="tag"
        data-url="https://m.haimati.cn/#/"
        @click="handleOpen"
        >
        <span data-url="https://m.haimati.cn/#/">📁</span>
        <p data-url="https://m.haimati.cn/#/"> 预约 </p>
      </div>
      <!-- <a
        class="tag"
        target="_blank"
